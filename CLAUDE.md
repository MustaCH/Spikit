...
- [x] **4. Ejecución iniciada** — `/pm` creó backlog en ClickUp el 2026-05-02: 3 spikes + 9 parents de épica (EP-0 a EP-8) + 16 sub-tasks. Sprint inaugural (spikes + EP-0 + EP-1) cerrado al 2026-05-05: spikes ✅, EP-0 (setup técnico) ✅, EP-1 (POC latencia) ✅ con ADR-0003. Quedan 2 tickets en `review` (UX/UI del estado "Iniciando…" derivado de ADR-0003, en QA). **Sprint actual (desde 2026-05-05):** EP-2 (Walking skeleton del dictado) + sus 8 sub-tasks — habilitada para arrancar por `/frontend`.
